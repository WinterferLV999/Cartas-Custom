...
function s.initial_effect(c)
	...
	e2_bomb:SetType(EFFECT_TYPE_QUICK_O)
	e2_bomb:SetCode(EVENT_FREE_CHAIN)   
	...
	-- EFECTO ③: Lluvia Masiva de Veneno en la Fase Final con tope máximo de 4 por monstruo (Obligatorio)
