...
function s.racon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsOriginalCodeRule,CARD_RA,10000080,10000090,101403130),e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
