...
function s.splimit(e,c)
	return not (c:IsOriginalSetCard(0x7b) and c:IsType(TYPE_XYZ)) and c:IsLocation(LOCATION_EXTRA)
end
function s.lizfilter(e,c)
	return not (c:IsOriginalSetCard(0x7b) and c:IsOriginalType(TYPE_XYZ))
end
--local no.2
function s.effcon(e,tp,eg,ep,ev,re,r,rp)
	return (r&REASON_XYZ)==REASON_XYZ and e:GetHandler():GetReasonCard():IsSetCard(0x7b)
end
