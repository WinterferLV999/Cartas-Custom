...
function s.spfilter(c,e,tp)
	-- CORREGIDO: Se cambió 'true' por 'false' para obligar a respetar las condiciones de invocación en los filtros del Deck
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	-- CORREGIDO: El parámetro número 5 se cambió de 'true' a 'false'. Ya no se ignoran las condiciones de invocación.
